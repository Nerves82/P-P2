...
namespace TakeMyAdvice.Pages
{
    public partial class GoodAdviceListPage : ContentPage
    {
        ...
        private void UpdateFromCache()
        {
            ...
            var advice = realm.All<AdviceModel>().Where(x => x.AdviceType == "good");
